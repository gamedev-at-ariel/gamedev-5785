...
ג.   **הצגה בהרצאה**: בכל הרצאה ייבחרו הפתרונות הטובים ביותר למטלה השבועית. 
    ...
    באחריות חברי הצוות לחלק ביניהם את ההצגות.
  ...
  עקרונית, כדי להציג יש להגיע להרצאה באוניברסיטה.
  סטודנטים המשרתים במילואים לזמן ממושך, ואינם יכולים להגיע לכמה הרצאות (- באישור מזכירות המחלקה), יקבלו אישור חריג להציג בזום.
